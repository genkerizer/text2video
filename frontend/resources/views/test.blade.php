...
<head>
    ...
    <link rel="stylesheet" href="{{url('asset/style.css?t=2')}}">
    <style>
  ...
  <div id="msform"> 
    ...
    <div class="table">
      ...
      <div class="table-content"> 
        ...
        <div class="table-row">   
          <div class="table-data">{{$generator->description_prompt}}</div>
          <div class="table-data"><a target="_blank" href="{{url('videos/'.$generator->inputvideo)}}">{{$generator->inputvideo}}</a></div>
          <div class="table-data">@if($generator->outputvideo)<a target="_blank" href="{{url('videos/'.$generator->outputvideo)}}">{{$generator->outputvideo}}</a>@else {{'---'}} @endif</div>
        </div>
        @endforeach
      </div>
    </div>
    <br><br>
    <p>*API: <a target="_blank" href="{{route('getdata')}}">Get Data</a> | Method:GET( id,prompt,video )</p>
